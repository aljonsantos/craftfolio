...
const Navbar = () => {
  ...
  return (
    <nav className={`navbar fixed w-full bottom-[24px] lg:bottom-[36px] left-0 flex justify-center transition-all duration-400 ${showNavbar ? 'translate-y-0 opacity-100' : 'translate-y-[180%] opacity-50'}`}>
