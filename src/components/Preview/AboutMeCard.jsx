...
const Contacts = ({ show }) => {
  ...
  return (
    <div className={`border border-accent-100/70 md:border-0 md:border-t rounded-3xl shadow-lg md:shadow-none md:rounded-none md:max-h-full md:opacity-100 ${transitionClass}`}>
      ...
      <div className={`p-3 border-t border-accent-100/70 md:max-h-full md:opacity-100 lg:p-5 lg:py-4 ${transitionClass}`}>
        <Socials />
      </div>
    </div>
  )
...
const AboutMeCard = () => {
  ...
  return (
    <div className="aboutme-card flex flex-col gap-1 md:border border-accent-100 md:rounded-3xl md:gap-0 md:sticky md:top-[70px] md:shadow-lg lg:shadow-2xl">
