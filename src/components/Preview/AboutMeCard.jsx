...
const Social = ({ link, children }) => {
  return (
    <a href={link} className="border border-transparent p-1 rounded-lg hover:bg-zinc-100  hover:border-zinc-200 hover:shadow-sm transition-all">
      {children}
    </a>
  )
}
  ...
  return (
    <div>
        <div className="flex items-center gap-1 md:gap-2">
          {/* Github */}
          <Social link="">
            <svg className="w-5 h-5 text-zinc-700" fill="currentColor" viewBox="0 0 23 23">
          ...
          {/* LinkedIn */}
          <Social link="">
            <svg className="w-5 h-5 text-zinc-700" fill="currentColor" viewBox="1 0 22 22">
          ...
          {/* Twitter / X */}
          <Social link="">
            <svg className="w-5 h-5 text-zinc-700" fill="currentColor" viewBox="-2 -2 26 26">
