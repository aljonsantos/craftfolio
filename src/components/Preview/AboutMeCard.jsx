...
const AboutMeCard = () => {
  ...
  return (
    <div className="aboutme-card bg-background-700 flex flex-col gap-1 md:border border-accent-100 md:rounded-3xl md:gap-0 md:sticky md:top-[70px] md:shadow-lg lg:shadow-2xl">
