...
const Input = ({ type, id, name, placeholder, value, onChange, error, onTouch, touched }) => {
  ...
  return (
    <div className="w-full relative">
      <input className="w-full p-3 rounded-xl bg-background border border-border/10 focus:outline-none focus:border-accent-200 text-content peer"
...
const Textarea = ({ id, name, placeholder, value, onChange, error, onTouch, touched }) => {
  return (
    <div className="w-full relative">
      <textarea className="w-full h-32 min-h-min max-h-60 p-3 rounded-xl bg-background border border-border/10 focus:outline-none focus:border-accent-200 text-content whitespace-pre peer"
